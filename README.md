...
MAFFT must be installed on your system for `fasta_trim_ref()`: - macOS: `brew install mafft` - Linux: `sudo apt install mafft` - Or download from <https://mafft.cbrc.jp/alignment/software/>
