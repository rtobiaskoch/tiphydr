...
#'   \item{major_lineage}{Lineage collapsed to one of `NY99`, `WN02`, `SW03`,
#'     `NY10` — whichever family has more markers present. Cross-family
#'     lineages with a tied marker count keep their own `lineage` name here
#'     instead of being forced to a side (chr).}
...
#'
#' @format A tibble with 49 rows and 5 columns:
#' \describe{
#'   \item{lineage}{Lineage name (chr).}
#'   \item{major_lineage}{Lineage collapsed to one of `NY99`, `WN02`, `SW03`,
#'     `NY10` — whichever family has more markers present. Cross-family
