...
lineages = define_lineage(trimmed[1:10], ref, muts_gff, type = "aa", gff = "data/genomic.gff")

lineages = define_lineage(trimmed, ref, muts, type = "aa")

lineages %>% dplyr::group_by(lineage) %>% dplyr::count()


unknown = c("VCTR0010000464|2021-08-25|West|AZ/Maricopa|Unknown|mosquito-culex",
